<template>
  <!-- Delete House Modal -->
      <div id="deleteHouseAlert" tabindex="-1"  aria-hidden="true" :style="{display: getIsDeleteHousePopupOpen ? 'block' : 'none'}"
        class="modal" :class= "{show: getIsDeleteHousePopupOpen}">
...
export default {
  name: 'deleteHouseModal',
  computed: {
    ...mapGetters({
        getIsDeleteHousePopupOpen: 'house/getIsDeleteHousePopupOpen'
    })
  },
  methods: {
