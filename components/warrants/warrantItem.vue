<template>
  <div class="warrants-item report-card-frontend" :class="{active: warrant.status === 'approved'}">
       <div @click="detailWarrant(warrant)" class="warrant-basic-info-wrapper"> 
...
<style scoped>
.warrant-basic-info-wrapper:hover {
  cursor: pointer;
}
</style>