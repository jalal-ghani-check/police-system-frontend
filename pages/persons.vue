                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="employees-card-list">
                            <div v-for="(profile, index) in profilesListComputed" :key="index" @click="selectProfile(index)" class="employees-name-card" :class="{active: index == selectedIndexComputed }" >
