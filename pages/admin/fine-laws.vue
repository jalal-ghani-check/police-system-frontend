    ...
    <div>
      <div class="fine-container">
            <div class="container">
                ...
                <div class="fine-list">
                    <div class="row" :v-if="(typeof lawsList.infraction !== 'undefined')">
                        <law-item v-for="(law, index) in lawsList.infraction" :key="index" :law="law" />
                    </div>
                </div>
                ...
                <div class="fine-list">
                    ...
                    <div class="row" :v-if="(typeof lawsList.misdemeanor !== 'undefined')">
                        <law-item v-for="(law, index) in lawsList.misdemeanor" :key="index" :law="law" />
                    </div>
                </div>
                ...
                <div class="fine-list">
                    <div class="row" :v-if="(typeof lawsList.felony !== 'undefined')">
                        <law-item v-for="(law, index) in lawsList.felony" :key="index" :law="law" />
                    </div>
                </div>
            </div>
        </div>
