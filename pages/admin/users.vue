        ...
        <div class="container">
            <div class="page-title-banner users">
                ...
                <div class="banner-btns">
                    <button @click="addNewUser"   class="btn btn-success"><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="title-header">
                            <div class="row">
                                ...
                                <div class="col-md-5 header-buttons">
                                    <button v-if="!isEditModeComputed && isAdmin" @click="editProfile()" class="btn btn-light">
                                    ...
                                    <button v-if="!isEditModeComputed && isAdmin" @click="deleteProfile()" class="btn btn-danger"><svg width="17" height="18" viewBox="0 0 17 18"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        Delete</button>
                                    <nuxt-link v-if="!isEditModeComputed" class="btn btn-primary" :to="'/messages?user_id=' + selectedEmployee.enc_user_id"><svg width="19" height="18" viewBox="0 0 19 18"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <add-new-user-modal :show-modal="showAddModalComputed" @close="closeAddModal" />
        </div>
    </div>
</template>
...
export default {
  components: { DeleteUserModal, AddNewUserModal },
  name: 'Users',
  layout: 'master',
  data () {
    return {
